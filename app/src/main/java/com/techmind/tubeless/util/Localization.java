...
public class Localization {
    ...
    private Localization(String countryCode, String languageCode) {
    }
    ...
    public static com.techmind.tubeless.util.Localization getPreferredExtractorLocal(Context context) {
        ...
        return new com.techmind.tubeless.util.Localization(countryCode, languageCode);
    }
